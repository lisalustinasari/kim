...
if (isset($_GET['cari'])) {
    ...
    $value = 1;
    $data_akun = $lib->showPagination3($nama, $limit, $limit_start);
    $data_akun_count_search = $lib->hitungPage4($nama);
} else {
    $page = (isset($_GET['page'])) ? $_GET['page'] : 1;
    $limit = 10;
    $limit_start = ($page - 1) * $limit;
    $data_akun = $lib->showPagination($limit, $limit_start);
}

if (isset($_GET['id'])) {
    $kd_pengguna = $_GET['id'];
    $status_hapus = $lib->deletePengguna($kd_pengguna);
    if ($status_hapus) {
        echo "<script type='text/javascript'>alert('Berhasil Mengapus Data Pengguna!');window.location.href = 'data_akun.php';</script>";
    } else {
        echo "<script type='text/javascript'>alert('Gagal Mengapus Data Pengguna!');window.location.href = 'data_akun.php';</script>";
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <h4 class="teal-text text-darken-2 container section judul">Data Pengguna</h4>
    <section class="container section scrollspy">
        <div class="row">
            <div class="col s12 l12 m12">
                <a class="btn-floating btn-medium waves-effect waves-light green pulse tooltipped" href="form_akun.php" data-position="top" data-tooltip="Tambah Data Pengguna"><i class="material-icons">add</i></a>
                <!-- Modal Trigger -->
        ...
        <div class="row">
            <div class="col offset-l8 l4 s12">
                <form action="" method="GET">
                    <div class="input-field">
                        <input placeholder="nama atau negara" id="search" type="text" name="cari" class="validate">
                ...
                <table id="data-table-simple" class="report highlight centered striped" cellspacing="0" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($data_akun as $row) {
                            ...
                            echo "<td>
                                                        <a href='form_ubah_akun.php?id=" . $row['id_akun'] . "' class='btn waves-effect waves-light blue tooltipped'class='btn tooltipped' data-position='top' data-tooltip='Edit'><i class='material-icons'>edit</i></a>
                                                        <a href='data_akun.php?id=" . $row['id_akun'] . "' class='btn waves-effect waves-light red tooltipped' class='btn tooltipped' data-position='top' data-tooltip='Hapus'><i class='material-icons'>delete</i></a>
                                                        </td>";
                            echo "</tr>";
                            $no++;
                        }
            ...
            <div class="col s12 l12 m12" style="margin-top:4px;">
                ...
                if (isset($_GET['cari'])) {
                    $cari = $_GET['cari'];
                    echo "Ditampilkan <b>" . count($data_akun) . "</b> dari sekitar <b>" . $data_akun_count_search . "</b>";
                }
                ?>
            </div>
            <div class="row right">
                <div class="col s12 l12 m12">
                    <ul class="pagination">
                        ...
                        ?>
                            ...
                            ?>
                                <li class="waves-effect"><a href="data_akun.php?cari=<?= $cari; ?>&page=1&page=<?php echo $link_prev; ?>"><i class="material-icons">chevron_left</i></a></li>
                            <?php
                            }
                        } else {
                            if ($page == 1) {
                            ...
                            <?php
                                ...
                                $link_prev = ($page > 1) ? $page - 1 : 1;
                            ?>
                                <li class="waves-effect"><a href="data_akun.php?page=1&page=<?php echo $link_prev; ?>"><i class="material-icons">chevron_left</i></a></li>
                        <?php }
                        } ?>
                        ...
                        <?php
                        if (isset($value) == 1) {
                            $hitungAkunSearch = $lib->hitungPage4($cari);
                        ...
                        ?>
                                <li<?php echo $link_active; ?>><a href="data_akun.php?cari=<?= $cari; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                <?php
                            }
                        } else {
                            for ($i = $start_number; $i <= $end_number; $i++) {
                                $link_active = ($page == $i) ? ' class="active teal"' : '';
                                ?>
                                    <li<?php echo $link_active; ?>><a href="data_akun.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                <?php
                            }
                        }
                                ?>
                                ...
                                ?>
                                    ...
                                    ?>
                                        <li class="waveseffect"><a href="data_akun.php?cari=<?= $cari; ?>&page=<?php echo $link_next; ?>&page=<?php echo $link_next; ?>"><i class="material-icons">chevron_right</i></a></li>
                                    <?php
                                    }
                                } else {
                                    if ($page == $jumlah_page) {
                                    ...
                                    <?php
                                        ...
                                        $link_next = ($page < $jumlah_page) ? $page + 1 : $jumlah_page;
                                    ?>
                                        <li class="waveseffect"><a href="data_akun.php?page=<?php echo $link_next; ?>&page=<?php echo $link_next; ?>"><i class="material-icons">chevron_right</i></a></li>

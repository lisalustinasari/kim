...
if (isset($_POST['tombol_tambah'])) {
  ...
  $add_status = $lib->registrasiTipe($tn);
  if ($add_status) {
    echo "<script type='text/javascript'>alert('Berhasil Menambah Data!');window.location.href = 'data_tipe.php';</script>";
  } else {
    echo "<script type='text/javascript'>alert('Gagal Menambah Data!');window.location.href = 'form_tipe.php';</script>";
  }
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Form Input Tipe | KIM</title>
  <style>
    .judul {
...
<body>
  ...
  <section class="container section scrollspy">
    <h4 class="teal-text text-darken-2 judul">Form Tambah Tipe</h2>
          ...
          <div class="col offset-l2 l6 s12 m12">
            <div class="row">
              <div class="input-field col s12 m12 l12">
                <input id="name" type="text" class="validate" name="tipe_names" required />

    ...
    <section class="container section scrollspy">
        ...
        <div id="modal1" class="modal">
            <div class="modal-content">
                <h4>Info</h4>
                <p><b>1. Export To Excel</b> jika ingin mengconvert(merubah) data menjadi excel silahkan klik tombol bergambar <i class="material-icons">description</i> berwarna hijau tua yang berada di sebelah tombol info.</p>
            </div>
